...
public class ThemeComparativeStatisticCalculator implements ComparativeStatisticsCalculator {

    private final Catalyst catalyst;
    private final OrganizationSurvey survey;
    private final StatisticsService statisticsService;

    public ThemeComparativeStatisticCalculator(Catalyst catalyst, OrganizationSurvey survey, StatisticsService statisticsService) {
